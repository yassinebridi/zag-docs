...
Next, import the required hooks and function for your framework. Now you can use
the accordion in your project! Below is a basic usage of the accordion machine.
