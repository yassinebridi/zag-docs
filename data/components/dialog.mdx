...
- Focus is trapped and scrolling is blocked when modal.
...
Now you can use the dialog in your project!
...
how we name its parts. Each part includes a `data-part` attribute to help
...
- **Title**: The human readable title of the dialog.
- **Description**: The human readable description that supports the title.
...
> ensure that the dialog and its part has a unique identifier.

<CodeSnippet id="dialog/usage.mdx" />

## Methods and Properties

The dialog's connect method exposes the following methods:
