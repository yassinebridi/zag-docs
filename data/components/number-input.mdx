...
The number input component provides controls for editing, incrementing or
decrementing numeric values using the keyboard or pointer.
...
Now you can use the number input in your project!

```jsx
import * as numberInput from "@ui-machines/pin-input"
```
...
The number-input's connect method exposes the following methods:
