...
A slider is used to allow users to make selections from a range of values. Think
of it as a custom `<input type='range'/>` with the ability to achieve custom
...
Now you can use the slider in your project!
...
The slider's api provides properties and methods you can use to programmatically
read and set the slider's value.
