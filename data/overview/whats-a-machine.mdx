...
State machines are a tool for modeling stateful, reactive systems. They are
useful for declaratively describing the behavior of an application or component.
